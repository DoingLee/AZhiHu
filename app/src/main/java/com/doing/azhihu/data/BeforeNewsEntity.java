...
public class BeforeNewsEntity {
     ...
     * date : 20131118
     */
    private List<LatestNewsEntity.StoriesEntity> stories;
    private String date;

    public void setStories(List<LatestNewsEntity.StoriesEntity> stories) {
    ...
    public List<LatestNewsEntity.StoriesEntity> getStories() {
        return stories;
    }
