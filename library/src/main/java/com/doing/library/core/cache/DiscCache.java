package com.doing.library.core.cache;
...
import com.doing.library.core.io.IOUtils;
import com.doing.library.core.io.NameGenerator;
import com.doing.library.core.io.SafeFileNameGenerator;
import com.doing.library.core.utils.AndroidUtils;
import com.doing.library.core.utils.LogUtils;
...
public class DiscCache implements IDiscCache {
    ...
    public static final int MODE_AUTO = 2; //SD卡可用：外部缓存；SD卡不可用：内部缓存
    private int mMode = MODE_AUTO;
    public static final String DIR_NAME_DEFAULT = ".autoCache";
    ...
    /**
     * 默认：MODE_AUTO模式下，缓存在".autoCache"目录下
     * @param context
     */
     ...
     * @param context
     * @param dirName 缓存目录名字
     * @param mode  缓存模式：MODE_INTERNAL  MODE_EXTERNAL  MODE_AUTO
     */
