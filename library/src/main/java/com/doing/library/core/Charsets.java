...
package com.doing.library.core;

/**
 * Created by Doing on 2016/7/25 0025.
 *
 * 获取不同的 java.nio.charset.Charset 实例
 * java.nio.charset.Charset实例使用方法见：http://docs.oracle.com/javase/7/docs/api/java/nio/charset/Charset.html
 *
 */
...
//   static Charset  forName(String charsetName)：Returns a charset object for the named charset.
    ...
    public static Charset toCharset(Charset charset) {
        return charset == null ? Charset.defaultCharset() : charset;  //UTF-8
    }
